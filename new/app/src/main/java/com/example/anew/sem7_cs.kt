...
class sem7_cs : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_sem7_cs)
    ...
    fun call(v: View?) {
        ...
        if (i31.text.isNullOrEmpty() || i32.text.isNullOrEmpty() || i33.text.isNullOrEmpty() || i34.text.isNullOrEmpty() || i35.text.isNullOrEmpty() || i36.text.isNullOrEmpty() || i37.text.isNullOrEmpty() ) {
            ...
            if (flag == 0) {
                ...
                var a =
                    ((n1 * 4) + (n2 * 4) + (n3 * 3) + (n4 * 3) + (n5 * 3) + (n6 * 2) + (n7 * 1)) / 20.0
                //var ans = a.toString()
