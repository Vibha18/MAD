...
class sem7v : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_sem7v)
    ...
    fun call(v: View?) {
        ...
        if (i31.text.isNullOrEmpty() || i32.text.isNullOrEmpty() || i33.text.isNullOrEmpty() || i34.text.isNullOrEmpty() || i35.text.isNullOrEmpty() || i36.text.isNullOrEmpty()  ) {
            ...
            if (flag == 0) {
                var a =
                    ((n1 * 3) + (n2 * 2) + (n3 * 3) + (n4 * 3) + (n5 * 3) + (n6 * 10)) / 24.0
                //var ans = a.toString()
