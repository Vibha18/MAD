...
class sem1v : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_sem1v)
    ...
    fun call(v: View?) {
        ...
        var i38 = findViewById<View>(R.id.s41) as EditText

        var i39 = findViewById<View>(R.id.s11) as EditText
        ...
        if (i31.text.isNullOrEmpty() || i32.text.isNullOrEmpty() || i33.text.isNullOrEmpty() || i34.text.isNullOrEmpty() || i35.text.isNullOrEmpty() || i36.text.isNullOrEmpty() || i37.text.isNullOrEmpty() || i38.text.isNullOrEmpty() ||i39.text.isNullOrEmpty()) {
            ...
            if (flag == 0) {
                var a =
                    ((n1 * 3) + (n2 * 3) + (n3 * 3) + (n4 * 3) + (n5 * 3) + (n6 * 1) + (n7 * 1) + (n8 * 2) + (n9 * 1)) / 20.0
                //var ans = a.toString()
    ...
    fun reset(v: View?) {
        ...
        et7.text.clear()
        val et8: EditText = findViewById(R.id.s41)
        et8.text.clear()
        val et9: EditText = findViewById(R.id.s11)
        et9.text.clear()
